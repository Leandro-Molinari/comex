...
public class MainInsercaoProduto {
	...
	private static void adicionaVariavel(Produto produto, PreparedStatement statement) throws SQLException {
		...
		private static void adicionaVariavel(ProdutoIsento produtoIsento, PreparedStatement statement) throws SQLException {
			statement.setString(1, produtoIsento.getNome());
			statement.setString(2, produtoIsento.getDescricao());
			statement.setDouble(3, produtoIsento.getPreco_Unitario());
			statement.setInt(4, produtoIsento.getQuantidade_Estoque());
			statement.setInt(5, produtoIsento.getCategoria_id());
			statement.setString(6, produtoIsento.getTipo().name());
			statement.execute();
